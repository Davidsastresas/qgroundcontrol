...
{
    QList<int> rgStdIds = { araceFirstRunPromptId, araceFirstRunVideoPromptId, araceFirstRunLinksPromptId };
    return rgStdIds;
}
...
QString QGCCorePlugin::firstRunPromptResource(int id)
{
    ...
    case araceFirstRunPromptId:
        return "/FirstRunPromptDialogs/AraceFirstRunPrompt.qml";
    case araceFirstRunVideoPromptId:
        return "/FirstRunPromptDialogs/AraceFirstRunPromptVideo.qml";
    case araceFirstRunLinksPromptId:
        return "/qml/AraceFirstRunPromptLinks.qml";
    }
